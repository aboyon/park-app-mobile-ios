const es = {
  ...
  home: {
    ...
    searchDisabledReservation: 'La búsqueda de estacionamientos está pausada mientras tenés una reserva activa.',
  ...
  activeReservation: {
    ...
    periods: 'Períodos',
    renewalNotice: 'Tu estadía fue renovada automáticamente. Se aplicó un cargo adicional de %{rateType}.',
    rateTypeHourly: 'Por hora',
    rateTypeHalfDay: 'Medio día / 12hs',
    rateTypeEntireDay: 'Día completo / 24hs',
  },
  ...
  parkingDetail: {
    ...
    selectRateType: 'ELEGÍ TU ESTADÍA',
    rateTypeHourly: 'Por hora',
    rateTypeHourlyHint: 'Cobro por hora',
    rateTypeHalfDay: '12hs',
    rateTypeEntireDay: '24hs',
    openMaps: 'Abrir en Mapas',
